    ...
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center">
        ...
        <form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
          <input type="text" class="form-control px-4" placeholder="Search Your Future Home" />
            ...
            <div class="property-item">
              ...
              <div class="property-content">
                ...
                <div>
                  ...
                  <a href="{{ route('property.show', $property->slug) }}" class="btn btn-primary py-2 px-3">See details</a>
                </div>
              </div>
            </div>
            @endforeach
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0">
        <div class="h-100 person">
          <img src="{{ Storage::url($agent->photo) }}" alt="Image" class="img-fluid" />
          ...
          <div class="person-contents">
            ...
            <ul class="social list-unstyled list-inline dark-hover">
              <li class="list-inline-item">
                <a href="{{$agent->twitter}}" style="align-items:center;">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16" style="margin-top:20%">
              ...
              <li class="list-inline-item">
                <a href="{{$agent->facebook}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16" style="margin-top:25%">
              ...
              <li class="list-inline-item">
                <a href="{{$agent->linkedin}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16" style="margin-top:25%">
              ...
              <li class="list-inline-item">
                <a href="{{$agent->instagram}}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16" style="margin-top: 25%;">
